        ...
        if (this.props.user) {
            return (
                <div style={{ fontSize }}>
                    ...
                    <p>
                        To do that first go to the page where the wanted questions are.
                        ...
                        select a personal directory where the questions will be copied to. Alternatively
                        you can create a new directory by first selecting the parent directory and then 
                        clicking "Create New". After the questions are copied you can then edit and 
                        track your answers rates.
                    </p>
                    <p  style={questionStyle}>How do I test myself?</p>
                    <p>
                        You can do that in two ways - one is on a single question and the other is on
                    ...
                    <p>
                        ...
                        <ul>
                            <li>
                                Transperant Blocks: you put the tag that coresponds to the desired block
                            ...
                            <li>
                                There is also the options to use shortcuts. First you select the text you
                                want to format, then pres ctrl + the letter that corresponds to the wanted 
                                formating. You can see the leter in the info to the right on the screen.
                                The tags will be applied in an appropriate manner.
                            </li>
                        </ul>
                    </p>
                </div>
